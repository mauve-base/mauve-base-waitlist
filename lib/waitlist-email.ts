...
<html lang="en">
  <body style="margin:0;padding:0;background:${PAPER};">
    ...
    <div style="max-width:520px;margin:0 auto;padding:40px 24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:${INK};">
      ...
      <p style="margin:18px 0 0;font-size:16px;line-height:1.6;color:${INK};opacity:0.78;">
        ${greeting} for requesting early access to Mauve Base. Confirm this email address to lock in your place on the waitlist &mdash; we&rsquo;ll only reach out as we onboard.
      </p>
  ...
  const text = [
    ...
    "",
    `${greeting} for requesting early access to Mauve Base. Confirm your email address to lock in your place on the waitlist:`,
    "",
    confirmUrl,
    "",
